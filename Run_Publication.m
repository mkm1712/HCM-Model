...
% Setting Run parameters
 ...
 eps_val=0.05;
 tspan = 200; 
%  pp=[10, 951]; %Plot variables

 % Run initial simulation
[t1,y1]=St_ode(params,y0,eps_val,tspan,dt);
% plot(t1,y1(:,pp),Color='b')
% hold on
